package edu.kh.book.member.model.dao;
...
public class MemberDAO {
	...
	public MemberDAO() {
		try {
			...
			String filePath
				= MemberDAO.class.getResource("/edu/kh/book/sql/member-sql.xml").getPath();
	...
	public Member login(Connection conn, String inputId, String inputPw) throws Exception {
		...
		try {
			...
			if(rs.next()) {
				...
				loginMember.setMemberName(rs.getString(4));
				loginMember.setMemberAdress(rs.getString(5));
